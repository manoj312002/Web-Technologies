...
$files=glob("C:\xampp\htdocs\fb\upload");
...
$user = $_SESSION["name"];
$s="SELECT * FROM fb1 WHERE Username='$user';";
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<table border=1 style="width:70%;height:30%;margin-top:100px;color:black;">';
    echo '<h2 style="color:black;text-align:center>Profile of"'. $name . '</h2>';
